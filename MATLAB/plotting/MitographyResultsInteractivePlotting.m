...
% and boolean variables. Interactively plot them, with possibility to split
% results for various boolean variables.
% Version - Interactive plotting
%
%%%
...
onlyPlottingGUI(actinLen, mitoLen, 3, 0, 100, 0.2, 2, 'Extra parameter')
uiwait
load('checkboxes.mat');
...
%%% STRIPES PLOTTING BELOW

interactivePlottingGUI(fontSizeGlobal, filamentWidthSNZ, mitoDisplacementEdgeS, mitoActinDistS, filamentWidthNSNZ, mitoDisplacementEdgeNS,...
    ...
    mitoLengthNP, nonzeroNP, mitoPatchOverlapP, mitoPatchOverlapNP, paramName)
