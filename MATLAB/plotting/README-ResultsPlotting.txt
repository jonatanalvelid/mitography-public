...
2. Run "ResultsHistogramPlotting..." for the variables you want to look at.
	...
	e. Change the "Last image number" field to the last image number of your dataset.
	f. Press the button of the histrograms you are interested in: "Primary morphology" for width, length, area etc., "Actin" for actin-mito distance. 
