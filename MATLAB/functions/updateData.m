function [filamentWidthSNZ, mitoDisplacementEdgeS, mitoActinDistS, mitoActinDistD2S, filamentWidthNSNZ, mitoDisplacementEdgeNS,...
    ...
    nonzeroP, mitoWidthNP, mitoAreaNP, mitoLengthNP, nonzeroNP, mitoPatchOverlapP, mitoPatchOverlapNP, mitoNonStripesDistP, mitoNonStripesDistNP, paramName] = updateData191113(doubleTol, doubleTol2, singleTol)
    ...
    for fileNum = fileNumbers
        ...
        try
            ...
            nonstripesdistMito = data(1:end,10);  %Patch distance
...
%               % Distance to nearest actin non-stripes binary patch
    ...
    for fileNum=fileNumbers
        ...
        for i=1:mitosPerFile
            ...
            if mitoAreaFiles(i,2,fileNum) ~= 0 && somaParamFiles(i,2,fileNum) == 0
