...
legend(strcat('Confocal PSF, W=',int2str(floor(confwid*1000)),'nm'),strcat('STED PSF, W=',int2str(floor(STEDwid*1000)),'nm'),strcat('Mitochondria, W=',int2str(floor(mitosize*1000)),'nm'),strcat('Confocal, W=',int2str(floor(confFWHM*1000)),'nm'),strcat('STED, W=',int2str(floor(mitosize*1000)),'nm'),'Location','northeast')
