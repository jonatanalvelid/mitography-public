% XZ images with different imaging modalities of an MPS ring with actin
% labelling

%%%
% Parameters
PSFxy = 0.040;  % STED PSF, xy FWHM
PSFz = 0.100;  % 3DSTED PSF, z FWHM
PSFGauxy = 0.230;  % Conf PSF, z FWHM
PSFGauz = 0.600;  % Conf PSF, z FWHM
pxs = 0.005;  % Pixel size, um
imgsize = 0.75;  % Image size, um
ringdiameter = 0.300;  % Ring diameter, um
dotdist = 0.01;  % Label-label distance, um
angleamountmissing = 30;  % Angle extent of missing label at top and bottom
MPSmissing = 0;  % Boolean if simulate the ring with missing label or not
%%%
...
figure('rend','painters','pos',[100 100 1600 800])
subplot(2,4,1)
imshow(imgMPS)
title('Model - MPS ring')
subplot(2,4,2)
