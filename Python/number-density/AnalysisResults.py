...
# directory path, replace with absolute path to the provided relative path
dirpath = os.path.join('.../mitography-public/example-data/number-density/oxphos-axde/results-aa')
